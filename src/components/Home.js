      ...
      <div className="container">
        <div className="row">
          <div className="col-lg-8 offset-lg-2 my-5">
            ...
            <p className="lead">
              You will be creating a movie browser that's API driven. There's a
              search function, movie detail view, about page, all built into a
              single page application / progressive web application.
            </p>
            <p className="lead">
              There are tasks I have purposely left out of this project for you
              to solve on your own. This is VERY similar to a take home
              assignment that a company will give you when you apply to work
              with them.
            </p>
            <p className="lead">
